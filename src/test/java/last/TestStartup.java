...
public class TestStartup extends TestCase {
    ...
    public static class MockPanicPolicy implements PanicPolicy {
        public boolean panic (Panic panic) {
            throw new ShutdownException(panic.toString());
        }
    }
    ...
    public void testGetKeysKeystoreUndefined () {
        ...
        setupMiranda();
        Miranda.getInstance().setPanicPolicy(new MockPanicPolicy());
    ...
    @Test
    public void testGetKeysPublicKeyAliasUndefined () {
        ShutdownException shutdownException = null;

        setupMiranda();
        Miranda.getInstance().setPanicPolicy(new MockPanicPolicy());
        MirandaProperties mirandaProperties = new MirandaProperties();
        mirandaProperties.remove(MirandaProperties.PROPERTY_KEYSTORE_PUBLIC_KEY_ALIAS);
        getStartup().setProperties(mirandaProperties);
        try {
            getStartup().getKeys();
        } catch (ShutdownException e) {
    ...
    public void testGetKeysWrongPassword () {
        ...
        MirandaProperties mirandaProperties = new MirandaProperties();
        getStartup().setProperties(mirandaProperties);
        getStartup().setKeystorePassword("wrong");
        try {
            getStartup().getKeys();
        } catch (ShutdownException e) {
            shutdownException = e;
