...
public class TestRetryingState extends TesterNodeState {
    ...
    public void testStart () {
        ...
        verify(getMockTimer(), atLeastOnce()).scheduleOnce(Matchers.anyLong(), Matchers.any(BlockingQueue.class),
    ...
    public void testProcessConnectFailedMaxTime () {
        ...
        verify(getMockTimer(), atLeastOnce()).scheduleOnce(Matchers.eq(RetryingState.MAX_TIME), Matchers.any(BlockingQueue.class),
                Matchers.any(RetryMessage.class));
    }
    ...
    public void testProcessConnectFailedDelayDoubles () {
        ...
        verify(getMockTimer(), atLeastOnce()).scheduleOnce(Matchers.eq(RetryingState.INITIAL_DELAY), Matchers.any(BlockingQueue.class),
                Matchers.any(RetryMessage.class));
        ...
        verify(getMockTimer(), atLeastOnce()).scheduleOnce(Matchers.eq(2 * RetryingState.INITIAL_DELAY),
