...
public class Panic extends Exception {
    ...
    public enum Reasons {
        ...
        UnrecognizedResult, ExceptionCreatingNode, ExceptionTryingToStart, ExceptionSettingData, Exception, FailedWritigFile, Inerrupted, ExceptionInExit, ExceptionCreatingEvent, CacheIsFull, ExceptionCreatingSubscription, EventQueueWriteFailed, DirectoryDoesNotExist, ExceptionShuttingDown;
    }
