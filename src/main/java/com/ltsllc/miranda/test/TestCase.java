...
public class TestCase {
    ...
    public static void setupTrustStore () {
        ...
        createFile(filename, TRUST_STORE_CONTENTS);
    }
    ...
    public static void cleanupTrustStore () {
        MirandaProperties properties = MirandaProperties.getInstance();
        deleteFile(properties.getProperty(MirandaProperties.PROPERTY_TRUST_STORE));
    }
    ...
    public static void setupMirandaProperties() {
        //
