...
import com.ltsllc.miranda.servlet.user.request.UserObjectRequest;
 ...
 */
public class CreateUserServlet extends SessionServlet {
    public Class getRequestClass () {
        return UserObjectRequest.class;
    }
    ...
    public ResultObject performService(HttpServletRequest req, HttpServletResponse resp, Request requestObject)
            throws ServletException, IOException, TimeoutException {
        ResultObject resultObject = new ResultObject();

        try {
            User user = ((UserObjectRequest) requestObject).getUser();
